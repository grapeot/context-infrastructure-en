...
- [External Writing Workflow](./workflow_external_writing.md) ✅ — Turn material that passed the thesis gate into an external-facing analysis. The three-stage writing route is AGY IC-1 structural draft → fresh AGY IC-2 low-cognitive-burden rewrite → fresh AGY IC-3 independent prose QA
